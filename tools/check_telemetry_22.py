...
def main():
    readings_20260522 = r2_get_json("rain/readings/20260522.json")
    if not readings_20260522:
        print("Could not load readings!")
        return

    stations = ["000180TP", "237740TP", "238944TP", "238777TP"]
    all_readings = readings_20260522.get("readings", {})
